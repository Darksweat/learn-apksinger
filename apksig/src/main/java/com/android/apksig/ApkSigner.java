...
public class ApkSigner {
    ...
    private void sign(
        ...
        try {
            // TODO 分析输入文件的zip结构，ZipEndOfCentralDirectory和CentralDirectory
        ...
        try {
            // TODO 通过输入apk包的文件结构信息计算ApkSigningBlock的信息，start位置
            ...
            // TODO 获取签名块的Contents，个人是觉得这里做有点多余，前面应该直接判断minsdk，如果只能用v1签名这个就没有必要做了
            inputApkSigningBlock = apkSigningBlockInfo.getContents();
        } catch (ApkSigningBlockNotFoundException e) {
            // TODO ?? 这里还有什么特殊处理吗？怎么感觉有的apk包可以包含APK Signing Block，有的包不包含，打包不是一样的流程么
        ...
        // TODO 文件头到APK Signing Block start之前区域的DataSource，这里判断有木有APK Signing Block，木有，start位置就是CentralDirectory的start位置，有，start就是APK Signing Block的start位置
        // TODO Contents of ZIP entries
        ...
        // TODO 看代码是去找一个PIN_HINT_ASSET_ZIP_ENTRY_NAME路径的文件，不明白这个文件干啥的
        ...
        // TODO 如果有ApkSigningBlock把其对应的DataSource塞到signerEngine里面
